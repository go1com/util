...
class Queue
{
    ...
    const PORTAL_CUSTOMER_CREATE       = 'portal_customer.create';
    const PORTAL_CUSTOMER_UPDATE       = 'portal_customer.update';
    const PORTAL_CUSTOMER_DELETE       = 'portal_customer.delete';
