...
class CreditHelper
{
    ...
    {
        return static::count($db, $ownerId, $productId, $productType, [Credit::STATUS_AVAILABLE, Credit::STATUS_USED]);
    }

    public static function used(Connection $db, int $ownerId, int $productId, string $productType = 'lo')
    {
        return static::count($db, $ownerId, $productId, $productType, [Credit::STATUS_USED]);
    }

    public static function remaining(Connection $db, int $ownerId, int $productId, string $productType = 'lo')
    {
        return static::count($db, $ownerId, $productId, $productType, [Credit::STATUS_AVAILABLE]);
    }
